...
const file_proto_shorturl_proto_rawDesc = "" +
	"\n" +
	"\x14proto/shorturl.proto\x12\bshorturl\"\"\n" +
	...
	"\x03url\x18\x01 \x01(\tR\x03url2\xe4\x03\n" +
	"\x10ShortenerService\x12>\n" +
	"\aPostURL\x12\x18.shorturl.ShortenRequest\x1a\x19.shorturl.ShortenResponse\x12B\n" +
	"\vShortenPost\x12\x18.shorturl.ShortenRequest\x1a\x19.shorturl.ShortenResponse\x12Q\n" +
	"\x10ShortenBatchPost\x12\x1d.shorturl.ShortenBatchRequest\x1a\x1e.shorturl.ShortenBatchResponse\x12A\n" +
	"\bRedirect\x12\x19.shorturl.RedirectRequest\x1a\x1a.shorturl.RedirectResponse\x127\n" +
	"\bUserUrls\x12\x0f.shorturl.Empty\x1a\x1a.shorturl.UserUrlsResponse\x12B\n" +
	"\x0eDeleteUserUrls\x12\x1f.shorturl.DeleteUserUrlsRequest\x1a\x0f.shorturl.Empty\x129\n" +
	"\rInternalStats\x12\x0f.shorturl.Empty\x1a\x17.shorturl.StatsResponseB\x10Z\x0eshorturl/protob\x06proto3"
...
var file_proto_shorturl_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_proto_shorturl_proto_depIdxs = []int32{
	...
	0,  // 4: shorturl.ShortenerService.ShortenPost:input_type -> shorturl.ShortenRequest
	4,  // 5: shorturl.ShortenerService.ShortenBatchPost:input_type -> shorturl.ShortenBatchRequest
	11, // 6: shorturl.ShortenerService.Redirect:input_type -> shorturl.RedirectRequest
	9,  // 7: shorturl.ShortenerService.UserUrls:input_type -> shorturl.Empty
	8,  // 8: shorturl.ShortenerService.DeleteUserUrls:input_type -> shorturl.DeleteUserUrlsRequest
	9,  // 9: shorturl.ShortenerService.InternalStats:input_type -> shorturl.Empty
	1,  // 10: shorturl.ShortenerService.PostURL:output_type -> shorturl.ShortenResponse
	1,  // 11: shorturl.ShortenerService.ShortenPost:output_type -> shorturl.ShortenResponse
	5,  // 12: shorturl.ShortenerService.ShortenBatchPost:output_type -> shorturl.ShortenBatchResponse
	12, // 13: shorturl.ShortenerService.Redirect:output_type -> shorturl.RedirectResponse
	7,  // 14: shorturl.ShortenerService.UserUrls:output_type -> shorturl.UserUrlsResponse
	9,  // 15: shorturl.ShortenerService.DeleteUserUrls:output_type -> shorturl.Empty
	10, // 16: shorturl.ShortenerService.InternalStats:output_type -> shorturl.StatsResponse
