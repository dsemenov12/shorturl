...
const (
	...
	ShortenerService_ShortenPost_FullMethodName      = "/shorturl.ShortenerService/ShortenPost"
...
type ShortenerServiceClient interface {
	...
	ShortenPost(ctx context.Context, in *ShortenRequest, opts ...grpc.CallOption) (*ShortenResponse, error)
...
func (c *shortenerServiceClient) ShortenPost(ctx context.Context, in *ShortenRequest, opts ...grpc.CallOption) (*ShortenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShortenResponse)
	err := c.cc.Invoke(ctx, ShortenerService_ShortenPost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortenerServiceServer interface {
	...
	ShortenPost(context.Context, *ShortenRequest) (*ShortenResponse, error)
...
func (UnimplementedShortenerServiceServer) ShortenPost(context.Context, *ShortenRequest) (*ShortenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ShortenPost not implemented")
}
...
func _ShortenerService_ShortenPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShortenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShortenerServiceServer).ShortenPost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShortenerService_ShortenPost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).ShortenPost(ctx, req.(*ShortenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ShortenPost",
			Handler:    _ShortenerService_ShortenPost_Handler,
		},
		{
